...
export function Classement({ classement }: { classement: ClassementData }) {
  return (
    <div style={{
    ...
    >
      ...
      <div style={{ position: 'sticky', bottom: 0, background: 'linear-gradient(180deg,transparent,#c9a267 40%)', padding: '12px 16px 16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#e9d9b0', border: '3px solid #8a2f1f', borderRadius: 4, padding: '10px 12px', position: 'relative', boxShadow: '3px 4px 0 rgba(0,0,0,.3)' }}>
